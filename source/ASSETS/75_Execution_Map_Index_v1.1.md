...
- `숙소 후보` 핀은 예약 전 후보 위치다. Girona·Barcelona 지도는 Phase 8 확정 예약에 따라 `확정 숙소` 핀으로 교체했다.

| 거점 | 대상일 | HTML | GeoJSON | KML | 포인트 | 분류 |
|---|---|---|---|---|---:|---|
| Barcelona·Sitges | Day 1–4 | [HTML](75_Execution_Maps/Barcelona_Execution_Map_v0.2.html) | [GeoJSON](75_Execution_Maps/Barcelona_Execution_Map_v0.2.geojson) | [KML](75_Execution_Maps/Barcelona_Execution_Map_v0.2.kml) | 8 | 확정 숙소 1 · 핵심 방문지 5 · 교통 1 · 근교·이동지 1 |
