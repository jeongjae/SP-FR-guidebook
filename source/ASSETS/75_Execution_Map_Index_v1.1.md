...
- `숙소 후보` 핀은 예약 전 후보 위치다. Phase 8에서 실제 숙소 주소로 교체한다.
...
| Girona·Empordà | Day 4–7 | [HTML](75_Execution_Maps/Girona_Execution_Map_v0.2.html) | [GeoJSON](75_Execution_Maps/Girona_Execution_Map_v0.2.geojson) | [KML](75_Execution_Maps/Girona_Execution_Map_v0.2.kml) | 8 | 숙소 후보 1 · 핵심 방문지 2 · 근교·이동지 5 |
...
- HTML 8개에 숙소 후보 경고·범례·Google Maps 링크 반영
- KML 8개에 카테고리 접두어 반영
