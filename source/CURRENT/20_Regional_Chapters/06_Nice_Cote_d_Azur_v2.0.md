...
이름의 기원은 1820년대다. 흉년으로 일자리를 잃은 니스 주민들을 위해 영국인 체류 공동체가
해안 산책로 공사를 후원했고, 그 길이 '영국인의 길'로 불리다 지금의 이름으로 굳었다.
당시 니스는 아직 사르데냐 왕국 땅이었다 — **1860년 주민투표로 프랑스에 병합되기 전까지,
이 도시의 겨울 손님이 곧 도시의 산업이었다.**

7km 남짓한 산책로는 지금 니스의 러닝 트랙이자 자전거 도로이고, 우리 일정에서는 Jason 의
아침 러닝 코스다. 천사의 만(Baie des Anges)이라는 이름의 완만한 호를 따라 걷다 보면
바다 쪽에는 파라솔, 도시 쪽에는 벨에포크 호텔 파사드가 나란히 이어진다 — 그 유명한
네그레스코 호텔의 분홍 돔이 그 축의 정점이다.
...
니스의 5박은 이 구시가지를 '관광'이 아니라 '반복'으로 쓰는 일정이다 — 시장·저녁·산책이
전부 이 좁은 삼각형 안에서 돌아온다. 골목의 색은 이탈리아다. 1860년까지 사보이아 가문의
도시였던 흔적이 건물의 오커색과 덧창, 파스타 가게, 광장의 이름에 그대로 남아 있다.
**프랑스에서 가장 이탈리아다운 도시를 걷고 있다는 사실**이 이 구역 독해의 열쇠다.
...
1934년에 세워진 철골 지붕 시장이고, 영화제와 요트의 도시라는 이미지 뒤에서 **칸 사람들이
실제로 먹고 사는 물자가 이 지붕 아래로 모인다.** 주변 레스토랑 셰프들이 아침에 장을 보러
오는 시장으로 알려져 있고, 그래서 진열대의 수준이 곧 그날 칸 식탁의 수준이다.

우리 일정에서는 Day 9 아침의 첫 정차지다 — 시장을 먼저 보고 언덕(Le Suquet)으로 올라가는
순서라, 시장에서 산 과일 하나가 언덕길의 간식이 된다. 좌판 사이 통로가 좁아 배낭보다
숄더백이 편하고, 사진은 상인에게 한마디 묻고 찍는 것이 이 시장의 예의다. 지붕 아래라 비가 와도 일정이 깨지지 않는 것도 이 시장의 실용적 가치다 — Day 9 이 우천이면
칸 일정 전체에서 유일하게 계획대로 남는 곳이 여기다. 치즈·올리브 좌판에서 소량 포장을 부탁하면
대부분 응해 주고, 그렇게 산 것이 니스로 돌아가는 기차의 저녁 전 간식이 된다. 시장은 오전이 본체다 — 정오를 넘기면 좌판이 접히기 시작한다.
...
레랭 제도의 수도사들이 11세기에 이 언덕에 요새를 세웠고, 그 아래 어부들이 붙어 살면서
칸이 시작됐다. 언덕 정상의 카스트르 박물관(옛 성채)과 노트르담 드 레스페랑스 성당,
그리고 사각 망루가 구시가지의 스카이라인을 만든다. 골목은 좁고 가파르며, 계단 중간중간
집들 사이로 항구와 크루아제트가 조각조각 보이다가 **정상에서 한 번에 전체가 열린다** —
이 '조금씩 보이다 한꺼번에 열리는' 리듬이 이 언덕 산책의 핵심 경험이다.

정상 전망대에서는 항구의 요트, 크루아제트의 호텔 띠, 맑은 날에는 에스테렐 산괴의 붉은
능선까지 잡힌다. 내려오는 길에는 올라온 길과 다른 골목을 골라야 마을이 입체적으로 남는다. 언덕 초입의 좁은 계단길(Rue Saint-Antoine)은 저녁이면 식당 테라스가 골목을 채우는 구간인데,
우리는 낮에 지나므로 준비 중인 주방 냄새와 함께 걷게 된다 — 관광 식당가의 무대 뒤를 보는 셈이다. 언덕 전체는 천천히 돌아도 한 시간 남짓이라, 전망대에서 보내는 시간이 관람의 절반이 되도록 배분하는 것이 맞다.
...
지중해로 60m 솟은 이 바위는 1297년 프랑수아 그리말디가 수도사 복장으로 성문을 열게 해
빼앗은 이래 그리말디 가문의 자리다. 바위 위 마을은 골목 폭이 사람 둘 지나갈 정도로 좁고,
관광 상점 사이사이에 실제 주민의 문패가 붙어 있다 — **국가 전체가 한 동네 크기인 나라의
'수도 구시가지'를 걷는 경험**은 유럽에서도 여기뿐이다.

대성당에는 그레이스 켈리와 레니에 3세가 묻혀 있다. 할리우드 배우가 대공비가 된 1956년의
결혼은 이 소국이 카지노의 나라에서 글래머의 나라로 이미지를 바꾼 전환점이었다.
궁전 광장 난간에서는 항구(라 콩다민)와 몬테카를로 방향이 한눈에 들어와, **바위에서
내려가기 전에 오늘 걸을 경로 전체를 미리 보는 자리**가 된다. 골목 안 기념품 상점은 어디나 비슷하니, 시간은 성당과 난간 전망에 쓰는 편이 남는 장사다.
...
시장이 선 제네랄 드골 광장 일대는 옛 니스역 화물창고 권역이었고, 지금도 광장 옆에
옛 남부역(Gare du Sud) 건물이 푸드홀로 개조되어 남아 있다. 트램 1호선이 광장을 바로
지나가 숙소에서의 접근도 쉽다. 관광객 비율이 낮은 만큼 흥정도 시식도 프랑스어가 기본이지만,
**손가락과 미소로 충분히 통하는 시장**이다. 산 것을 그 자리에서 먹을 벤치가 광장에 많다. 화요일 방문(9/8)이므로 파장 시간보다 오전이 낫고, 시장 뒤에는 같은 광장에서 세탁소·슈퍼 동선으로 자연스럽게 이어진다.
...
| 숙소 | **확정 — Palais ALZIRA · 12 Rue Verdi, 06000 Nice** · Airbnb HMJ3HX8QAY (체크인 15:00 · 체크아웃 11:00) · 정원 딸린 로프트 50㎡ · 총액 €809.54 결제 완료 · 호스트 Catherine +33 6 21 70 18 70 |
...
| 09:00 | **Nice역 렌터카 인수** (확정 Hertz L672E080313) | Nice Railway Station 영업소 (Avenue Thiers, +33 4 97 03 01 20 · 수요일 08:00 개점). 자동변속·보험·편도반납·차체촬영. 수속 30–60분 |
...
#### 무엇인가 — 어촌 언덕과 리조트 해안이 겹친 도시

칸은 두 겹이다. 하나는 **Le Suquet 언덕**, 11세기부터 레랭 수도원의 수사들이 자리를 잡고
어부들이 붙어 살던 오래된 마을이다. 좁고 가파른 골목이 언덕 꼭대기의 노트르담 드 레스페랑스
성당과 옛 망루로 이어진다. 다른 하나는 **La Croisette**, 19세기 영국 귀족들이 겨울을 나러 오면서
만들어진 해안 산책로이고, 20세기에 영화제가 붙으면서 지금의 이미지가 굳었다.

두 겹 사이에 **Marché Forville** 이 있다. 관광지가 아니라 칸 사람들이 장을 보는 곳이고,
칸이 리조트이기 이전에 프로방스 해안 도시라는 사실이 여기서 가장 잘 보인다.

#### 왜 이 여행에 넣었는가

니스에서 TER 로 30분대다. **하루를 쓰되 이동이 가볍고, 성격이 니스와 다르다** — 니스가
생활도시라면 칸은 무대다. 무대를 무대로만 보면 얄팍하지만, **시장 → 언덕 → 해안** 순서로 걸으면
같은 도시의 세 시대가 한 줄로 읽힌다. Jason 의 스케치 대상으로는 Le Suquet 골목의 좁은 수직선과
항구의 마스트 숲이 Croisette 의 호텔 파사드보다 낫다.

#### 관람 포인트

1. **Marché Forville** — 오전에 먼저 간다. 치즈·해산물·과일 진열이 그날 해안의 물자를 보여준다.
2. **Le Suquet 언덕** — 골목을 올라 성당과 망루까지. 정상에서 항구·Croisette·에스테렐 산괴가 한 화면에 들어온다.
3. **Vieux-Port** — 요트와 어선이 같은 물에 떠 있는 구간을 본다.
4. **La Croisette** — 30분이면 충분하다. 영화제 궁전 앞 핸드프린트는 지나가며 본다.

| 항목 | 내용 |
|---|---|
| 접근 | Nice-Ville → Cannes TER 약 30–40분 {{badge:pending|시각·요금 공식 확인}} |
| 체류 | 5–6시간 |
| 요금 | 시장·언덕·해안 산책은 **무료**. 실내 시설은 이번 일정에 넣지 않았다 |
| 시장 | Marché Forville 는 월요일 휴장(브로캉트로 전환)이 알려져 있다 — **9/6 은 일요일이라 정상 운영 예상** {{badge:pending|운영일 공식 확인}} |
| 주의 | Le Suquet 는 경사와 계단이 있다. 한여름 오후 언덕은 그늘이 적다 |
| 식사 | 시장 부근 가벼운 점심. **저녁은 니스로 돌아와서** — 전체 리듬이 그렇게 짜여 있다 |

> **칸에서 하지 않을 것**
> 레랭 제도(생트마르그리트) 보트는 왕복과 섬 산책으로 반나절이 더 든다. 이 일정에서는 넣지 않는다.
> 명품거리 쇼핑도 같은 이유로 제외한다 — 칸의 두 겹을 보러 가는 것이지 소비하러 가는 것이 아니다.

---

### Monaco {{grade:priority|우선추천}}
...
모나코는 2km² 남짓한 주권국이고, 그 절반이 20세기 이후 바다를 메워 만든 땅이다.
중심에는 **Le Rocher**(바위)가 있다. 1297년 프랑수아 그리말디가 수도사로 위장해 요새를 빼앗은
이래 같은 가문이 700년 넘게 통치해 온 자리이고, 지금도 대공궁·대성당·정부청사가 그 바위 위에 있다.

바위 아래는 완전히 다른 도시다. **Monte Carlo** 는 1860년대에 카지노를 세워 재정을 세운 구역이고,
**La Condamine** 항구는 요트와 생활이 섞인 구간이다. **같은 나라 안에서 세 구역의 성격이
이렇게 다른 곳은 드물다** — 걸어서 20분 거리에 중세 요새, 벨에포크 리조트, 현대 금융도시가 붙어 있다.

#### 왜 이 여행에 넣었는가

니스에서 TER 로 20분대다. 칸이 '무대'라면 모나코는 **'국가라는 형식'을 걸어서 통과해 보는 경험**이다.
왕궁 교대식과 카지노 광장을 관광 항목으로 소비하는 대신, **바위 위(권력) → 항구(생활) → 몬테카를로(자본)**
순으로 내려오면 이 도시가 어떻게 조립됐는지가 보인다. 경사가 심한 도시라 순서를 거꾸로 잡으면 체력이 샌다.

#### 관람 포인트

1. **Monaco-Ville(Le Rocher)** — 골목·대성당·궁전 광장. 광장 난간에서 항구가 내려다보인다.
2. **위병 교대** — 매일 11:55 로 안내된다 {{badge:pending|공식 확인}}. 보게 되면 좋고, 맞추려고 일정을 비틀지 않는다.
3. **La Condamine 항구** — 바위에서 내려오는 길에 통과한다. F1 코스가 이 도로다.
4. **Casino Square** — 건물 안에 들어가지 않아도 광장에서 성격 차이가 충분히 읽힌다.

| 항목 | 내용 |
|---|---|
| 접근 | Nice-Ville → Monaco-Monte-Carlo TER 약 20–25분 {{badge:pending|시각·요금 공식 확인}} |
| 체류 | 6–7시간 |
| 요금 | 구시가지·항구·광장 산책은 **무료**. 궁전 내부·해양박물관은 선택이며 이번 기본안에는 없다 |
| 지형 | **엘리베이터와 에스컬레이터가 공공 시설로 곳곳에 있다.** 역에서 바위까지 오르막을 걷지 말고 이 시설을 쓴다 |
| 복장 | 카지노 구역과 대성당은 복장 규정이 있다. 성당은 어깨·무릎을 가린다 |
| 주의 | 여권을 소지한다 — 국경 검문은 없지만 다른 나라다 |

> **모나코에서 하지 않을 것**
> 카지노 입장, 해양박물관 내부, Japanese Garden 까지 모두 넣으면 하루가 부서진다.
> 체력이 남으면 **Larvotto 해안** 쪽으로 내려가 생활형 해안축을 보는 정도로 끝낸다.
...
> 아래 표는 선정 과정의 기록이며 더는 선택지가 아니다. Airbnb 예약번호 HMJ3HX8QAY · **총액 €809.54 결제 완료** (2026-08 예약서 확인) · 호스트 Catherine +33 6 21 70 18 70. 트래커 금액 입력만 남았다 {{badge:pending|트래커 입력}}.
