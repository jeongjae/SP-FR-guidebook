...
- **대표 촬영 장면:** Cours Mirabeau의 플라타너스 가로수와 분수, Place Richelme 아침 시장
- **기념품 방향:** Calissons d'Aix(전통 아몬드 과자), 프로방스 올리브유·라벤더 제품
- **일정 삭제 원칙:** 선택 쇼핑·두 번째 카페·추가 내부관람부터 삭제하고 핵심 예약과 당일치기 귀환 일정은 유지한다.
...
- **체류/요금**: 2–3시간 · 미술관 €16~€18 / 마을 무료 (니스 출발 후 오전 경유)
...
> **Editor's Verdict**: 16세기 가죽 향장갑에서 출발해 500년 전통을 이어온 세계 향수의 수도. 프라고나르 공장의 30분 무료 가이드 투어와 시향.
...
> **Editor's Verdict**: 1651년 옛 성벽 자리에 조성된 440m 플라타너스 가로수길. 북쪽의 카페와 남쪽 17세기 귀족 저택, 4대 역사 분수가 관통하는 엑상의 심장.
...
#### Bastide du Jas de Bouffan {{grade:optional|선택}}

> **Editor's Verdict (일정 미포함·대체안)**: 세잔이 20세부터 60세까지 40년간 머물며 화가로 성장했던 가문의 여름 저택 (본 일정에서는 제외·대체 옵션).
...
> **Editor's Verdict (일정 미포함·대체안)**: 엑상 건축의 황금빛 사암을 공급하던 옛 채석장. 직각으로 깎인 붉은 절벽과 숲속 세잔의 오두막 (본 일정에서는 제외·대체 옵션).
...
#### Marseille (마르세유 구항구·르 파니에·Mucem) {{grade:essential|필수}}

> **Editor's Verdict**: 엑상과 대비되는 지중해 항구대도시. Day 15에는 TER로 진입해 Vieux-Port–Le Panier–Mucem–Fort Saint-Jean 축을 잇는다.

- **체류/요금**: 당일치기 6–8시간 (TER 왕복)
- **상세 가이드**: [Marseille 전체 가이드 보기](../places/marseille.html) · [Vieux-Port](../places/vieux-port-marseille.html) · [Mucem](../places/mucem.html) · [Fort Saint-Jean](../places/fort-saint-jean.html) · [Le Panier](../places/le-panier.html) · [Notre-Dame de la Garde](../places/notre-dame-de-la-garde.html)

---

#### Cassis & Calanques {{grade:essential|필수}}

> **Editor's Verdict**: 석회암 절벽과 에메랄드빛 피오르드 만(Calanques)이 어우러진 작은 지중해 항구마을.

- **체류/요금**: 당일치기 5–7시간 · 유람선 투어 별도
- **상세 가이드**: [Cassis 항구 가이드](../places/cassis.html) · [Calanques 유람선 가이드](../places/calanques.html)

---

#### Pâtisserie Weibel {{grade:essential|필수}}

> **Editor's Verdict**: 1954년부터 이어온 엑상의 제과점. 칼리송(Calisson d'Aix)과 정통 프로방스 페이스트리를 다룬다.
...
> **Editor's Verdict**: 카시스 항구 수변에 자리한 전통 부야베스(Bouillabaisse) 및 지중해 해산물 전문 식당.
...
- **Tapenade** — 올리브에 케이퍼, 멸치, 올리브유를 갈아 만든 스프레드로 빵에 곁들인다.
- **Aïoli** — 마늘과 올리브유로 만든 소스로 데친 채소와 삶은 대구에 곁들인다.
- **Ratatouille** — 가지, 호박, 피망, 토마토를 올리브유에 끓여낸 채소 스튜.
- **Daube provençale** — 소고기를 프로방스 와인과 채소로 장시간 조려낸 고기 요리.
- **Soupe au pistou** — 제철 채소 수프에 바질·마늘·올리브유 페이스트를 얹어 먹는다.
- **Calissons d'Aix** — 아몬드 가루와 멜론 절임을 반죽해 아이싱을 입힌 엑상 명물 과자.
- **Panisse** — 병아리콩 가루 반죽을 기름에 튀겨낸 프로방스 연안의 간식.

프로방스에서는 지역 로제 와인도 대표적인 식문화 요소다. 운전하는 날에는 마시지 않고 저녁 식사 때 선택한다.

## 시장과 장보기

Place Richelme 시장은 Aix에서 장보기의 기준점이다. 아침에 청과물, 치즈(chèvre), 빵 등을 구입해 숙소에서 아침이나 가벼운 점심 식사를 준비하기 좋다. 상세 정보는 [Aix 시장 가이드](../places/place-richelme-place-des-precheurs.html)에서 확인한다.

## 일정에서 이용하는 식당과 카페

### 방문 업소

- **Pâtisserie Weibel (Aix)** — Place Richelme 시장 인근(2 Rue Chabrier) 테라스에서 커피와 함께 칼리송과 페이스트리를 즐길 수 있다. ([상세 정보](../places/patisserie-weibel.html))
- **Chez Gilbert (Cassis)** — 카시스 항구 수변에서 생선구이와 부야베스를 다룬다. ([상세 정보](../places/chez-gilbert-cassis.html))
...
- 당일치기 일정 중 피로가 누적되거나 귀환이 늦어질 경우 마지막 경유지를 먼저 생략하고 정시 귀환을 유지한다.
...
- **Musée Granet 특별전**: Paul McCartney, Photographer 1963–64 (2026-07-04–2027-01-03)
- **Mucem 특별전**: Mossi Traoré (2026-05-20–11-16)
- **Cézanne 2026**: 사후 120주년 기념 아틀리에 및 관련 시설 특별 운영
...
1. Aix-en-Provence Tourism — https://www.aixenprovencetourism.com/en/
2. Ville d’Aix-en-Provence — https://www.aixenprovence.fr/
3. Cézanne en Provence — https://www.cezanne-en-provence.com/
4. Musée Granet — https://www.museegranet-aixenprovence.fr/en/
5. Cassis Tourism — https://www.ot-cassis.com/en/
6. Mucem Marseille — https://www.mucem.org/en/
...
| Cassis & Calanques (석회암 절벽·유람선 투어·Port-Miou) | 복수 출처 확인 |
| Marseille (TER 왕복 36~45분·Vieux-Port·Le Panier·Mucem·Fort Saint-Jean) | 복수 출처 확인 |
| 프랑스 고속도로(A- 유료)·연료 표기(SP95/Gazole)·원형교차로 규칙 | 확인 |
...
- 대상 일정: **Day 12–16**
- 숙소 핀은 **확정 주소**다 — Les Toits de Méjanes (Airbnb), 2 Place Coimbra, entrée A, 6층.
...
*   **오늘의 결론**: 엑상 체크아웃 후 뤼르마랭과 쿠스텔레 시장을 거쳐 뤼베롱 농가 숙소로 진입하는 이동일이다.
...
| 시간 | 일정 | 실행 포인트 |
|---|---|--- |
| 08:00–08:45 | 체크아웃 및 짐 적재 | 숙소 정리 및 렌터카 수하물 적재 (가림막 확인) |
| 08:45–09:30 | Aix → Lourmarin 이동 | D943 북행 이동 (약 38km) |
| 09:30–11:30 | **Lourmarin** | 뤼베롱 관문 마을 산책, 카뮈의 흔적, 르네상스 고성 외관 |
| 12:00–13:30 | **Coustellet 시장** | 일요 파머스 마켓에서 농가 체류용 식재료(치즈·과일·빵·와인) 구매 |
| 13:30–15:00 | Goult 점심 | 구트 석조마을 이동 및 로컬 점심 식사 |
| 15:30–17:00 | **Luberon 농가 체크인** | 농가 숙소 도착, 주차 및 숙소 진입로 확인 후 정착 |
