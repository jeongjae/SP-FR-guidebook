...
**43일 중 유일한 시골 숙박이다.** 앞의 15일은 도시와 항구, 뒤의 23일은 리옹과 파리다. **농가에서 자는 밤은 여기 4박뿐이다.**

그래서 이 구간의 성공 기준이 다르다. 앞 구간은 "무엇을 봤는가"였지만, 여기는 **"얼마나 느리게 지냈는가"**다. 기존 원고가 Day 19를 '농가생활·산책·스케치'로 비워둔 것이 이 구간의 핵심이다.

동시에 **시장이 일정을 지배하는 유일한 구간**이다. 쿠스텔레(일)·고르드(화)·리슬(목)이 각각 다른 날에 서고, 이 여행의 4박이 그 세 요일을 정확히 통과한다. 우연이 아니라 시장 요일에 맞춰 짠 일정이다.
...
**같은 지역인데 마을마다 다른 돌을 썼다.** 지질이 다르기 때문이고, 그것이 마을의 인상을 결정한다. 마을 목록을 채우는 여행이 아니라 **돌의 변화를 따라가는 여행**으로 보면 4박이 하나로 묶인다.
...
프로방스 시장은 **오전에 서고 13시에 접는다.** 이 하나의 사실이 4박 내내 일정을 지배한다.
...
이 보강본의 배치는 하루 **두 곳**이다. Day 17 루시용+고울트, Day 18 고르드+보리+세낭크(반경 5km 안), Day 19 한 곳.
...
**Day 20에 그 마을에 간다.** 이 구간의 처음과 끝이 두 작가의 우정으로 이어진다.
...
> **생산자 시장이라는 것**
> 재판매상이 아니라 **생산자가 직접 파는** 시장이다. 관광 시장(리슬쉬르라소르그 일요일)과 성격이 반대다. 농가 4박의 **첫 장보기**를 여기서 하는 것이 이 일정의 설계다.
...
**이 여행에서 유일한 시골 숙박의 진짜 목적이 이 날이다.** 기존 원고가 '농가생활·산책·스케치'로 잡았다.
...
**9월 17일은 목요일이다.** 즉 **식료품 시장은 서지만, 세계적으로 유명한 그 골동품 시장은 아니다.**
...
| 19 | 9/16 수 | **농가 테라스** | 농가 |
| 20 | 9/17 목 | 리슬 시장 조달 | 아비뇽 도착 후 |

**식당은 4박 중 한 번이면 충분하다.** 이 구간의 목적이 농가 생활이다.
...
| 항목 | 특징 |
|---|---|
| **농가 4박** | **이 구간 최대 지출.** 주방·주차·세탁 포함 여부가 결정적 |
...
| 항목 | 방향 | 내용 |
|---|---|---|
| 시장 자가 조리 | **절감** | 4박 중 3회 저녁이면 상당하다 |
| 농가 주차 포함 | 절감 | 마을 주차비만 별도 |
| 루시용 무료 주차 | 절감 | 도보 15–25분 감수 |
| 골동품 구매 | **증가** | Day 20. **충동구매 주의** |
| 와인 구매 | 증가 | 이후 23일 운반 부담도 |

> **Day 20 골동품은 예산 항목으로 미리 정해 두라.** 리슬쉬르라소르그는 유럽에서 런던·파리 다음으로 중요한 골동품 중심지로 꼽힌다. 사고 싶은 것이 나온다.
...
| 순위 | 대안 | 빼야 할 것 | 추가 | 난이도 |
|---:|---|---|---|---|
| 1 | **Fontaine-de-Vaucluse** | Day 20 리슬 축소 | 1.5h | 낮음 |
| 2 | **Bonnieux** | Day 17 고울트 | 1.5h | 낮음 |
| 3 | **Lacoste** | Day 19 마을 | 1h | 낮음 |
| 4 | **Apt** | Day 17 오후 | 2h | 중간 |
| 5 | Ochre 워크숍 (루시용) | Day 19 | 3h | 중간 (예약) |
...
**왜 1순위인가** — Day 20에 리슬쉬르라소르그에서 **소르그 강의 하류**를 본다. 발원지가 차로 가깝다. **같은 강의 시작과 끝을 한 날에 보는 구조**가 만들어진다.

**넣는 법** — Day 20 시장을 짧게 끊고 이동. 다만 아비뇽 체크인 시각을 침범하지 않아야 한다.
...
**넣는 법** — Day 19 마을 선택을 메네르브·오페드 대신 라코스트로. 다만 **오르막이 있다.**
...
**Jason의 스케치와 직결된다.** Day 19의 농가 여백을 이것으로 채우는 선택이 가능하다.
...
| 항목 | 이유 |
|---|---|
| **마르세유·아비뇽 당일치기** | 아비뇽은 Day 20부터 4박 한다 |
...
| **일정과 시장 요일 일치** | 계산 검증 — Day 16 일 / Day 18 화 / Day 20 목 전부 일치 |
