...
관람 에너지 배분은 아레나 7 : 극장 3 정도가 알맞다. 입장권은 아레나와 묶인 결합권이 유리한지 창구에서 확인한다 {{badge:unverified|요금 확인}}. 무대 쪽에서 객석을 등지고 서면 성당 종탑이 프레임에 들어오는 각도가 있다 — 로마와 중세가 한 장에 겹치는 지점이다. 여름 해가 길어 오후 늦게도 관람이 가능하지만, 우리는 오전 배정이 원칙이다.
...
조형 언어가 그대로 남아 있다. 성당 본당은 무료이고 회랑만 유료다 {{badge:unverified|요금 확인}}. 회랑 2층 통로에서 성당 지붕과 종탑을 가까이 보는 각도가 나온다 — 올라갈 수 있는 날이면 놓치지 않는다. 팀파눔 조각은 정오 직사광보다 오전 사선광에서 입체가 산다. 회랑 안뜰의 정적은 아를 하루에서 가장 조용한 시간이 된다. 아레나의 함성 자리와 회랑의 침묵 자리를 같은 오후에 겪는 대비가 이 도시 하루의 구조다.
...
⚠ 마을과 성(Château des Baux)의 상세는 조사가 부족하다 {{badge:unverified|조사 필요}}.
...
⚠ 개선문과 마우솔레움은 유적 밖 도로변에 있어 **입장 없이 볼 수 있다** {{badge:unverified|확인 권장}}.

{{badge:unverified|운영·요금 확인 필요}}
