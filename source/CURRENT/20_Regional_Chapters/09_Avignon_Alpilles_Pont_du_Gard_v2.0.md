...
|보조   |히스토패드(디지털 태블릿) 제공 {{badge:pending|재확인}}|
|체류   |90–120분                                                               |
...
|조명   |기존 원고에 야간 조명 항목 있음 {{badge:pending|재확인}}|
...
|체류     |60–90분                                                                       |
|온도     |채석장 내부는 서늘하다 {{badge:pending|재확인}}|
...
|이름                                 |정체                           |비고                      |
|-----------------------------------|-----------------------------|------------------------|
|**Papeton d’Aubergine**            |가지 요리. 이름이 '교황'에서 왔다         |아비뇽 향토음식 {{badge:pending|재확인}}|
|**Daube avignonnaise**             |프로방스 도브의 아비뇽식. 양고기를 쓰는 판본이 있다|{{badge:pending|재확인}}|
...
|**Pont du Gard**|공식 주차장 이용 {{badge:pending|재확인}}|
|**Les Baux**    |마을 진입 불가. 외곽 주차 후 오르막 도보 {{badge:pending|재확인}}|
|**Saint-Rémy**  |중심 외곽                                                                                                    |
...
|Pont Saint-Bénézet                             |—                      |{{badge:pending|재확인}}|
