...
| 권장 교통권 | 공항→숙소는 장기여행 짐과 도착 피로를 고려해 **택시를 기본안**으로 두고, Aerobús A1은 대기 상황이 나쁠 때의 대안으로 쓴다. 시내에서는 두 사람이 함께 2구간 이상 탈 계획이면 **T-familiar 1존 €11.50**, 그보다 적으면 단일권을 쓴다. 공항 메트로 T1/T2에는 둘 다 사용할 수 없다. |
...
| 수단 | 비용·시간 | 적합 조건 | 판단 |
|---|---|---|--- |
| 택시 | 교통에 따라 약 30–45분, 비용 변동 | 장기여행 짐 2개 이상, 도착피로 | **기본안** — 환승 없이 체크인 |
| Aerobús | 요금은 탑승 전 공식 채널 재확인 | **첫 시내 정차 Plaça Espanya가 숙소 도보권** | 택시 대기가 길 때의 대안 |
| 공항 메트로 | 공항권 €5.90, 비통합 | 숙소가 L9S 환승에 유리, 짐 적음 | 첫날에는 비추천 |
...
**이번 체류 권장:** 공항 이동은 시내권과 분리한다. Day 2·3에 두 사람이 함께 2구간 이상 탈 계획이면 공동 T-familiar 1장을 쓰고, 그보다 적으면 단일권을 쓴다. T-familiar는 첫 검증일부터 30일 동안 8회 사용할 수 있으며 공유 인원은 같은 이동을 함께 해야 한다.
