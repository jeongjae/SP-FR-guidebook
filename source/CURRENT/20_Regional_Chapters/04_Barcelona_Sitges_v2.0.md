...
> **예약** {{fact:sant-pau-recinte-modernista.booking}}
...
> **운영** {{fact:barri-gotic.hours}} · **휴관** {{fact:barri-gotic.closed}}
> **예약** {{fact:barri-gotic.booking}}
...
> **에이샴플레와 비교하며 걸어라**
> 사그라다 파밀리아 일대(격자·팔각 교차로)와 비교하면, Gòtic의 감각 차이가 선명하다. **길 하나 폭이 다르고, 시야가 열리는 방식이 다르고, 소리가 다르다.**

> **로마 성벽을 찾아라**
> 대성당 주변에 로마 시대 성벽 조각이 건물 사이에 박혀 있다. 노바 광장(Plaça Nova)에 2개의 원형 탑과 수로교 아치가 남아있다.

> **광장은 갑자기 나타난다**
> Gòtic의 광장은 도착 지점이 아니라 사고(事故)처럼 나타난다. 펠립 네리 광장의 총탄 자국과 고요함, 왕의 광장의 중세 계단을 놓치지 말 것.

---
#### Biblioteca de Catalunya {{grade:priority|우선추천}}

> **운영** {{fact:biblioteca-de-catalunya.hours}} · **휴관** {{fact:biblioteca-de-catalunya.closed}}
> **예약** {{fact:biblioteca-de-catalunya.booking}} · **소요** {{fact:biblioteca-de-catalunya.duration}}

##### 무엇인가 — 산 파우의 전편

1926년, 카레르 데 로스피탈에 있던 옛 산타 크레우 병원의 기능이 새 병원으로 옮겨갔다. 그 비워진 고딕 건물이 지금 카탈루냐 국립도서관이다.

즉 **산 파우가 이 건물의 후계자다.** 순서를 알고 가면 이 방문의 의미가 완전히 달라진다.
...
> **왜 여기 오는가**
> 관광지가 아니다. 조용하고, 사람이 적고, **에어컨이 있다.** 한여름 오후의 열기를 피하는 실용적 선택이기도 하다.
...
| 예약 채널 | Trip.com · 확인번호 36558SG255002 · 예약번호 1400827967207904 |
...
- [x] 바르셀로나 숙소 예약 — Occidental Barcelona 1929, Trip.com 36558SG255002 (2026-08-05, 바우처 대조 2026-08). 무료취소 기한 기록만 남음
...
| **09:00–09:35** | **렌터카 인수** | Hertz Sants 영업소(C/ Viriat 45, +34 682 505 020) · **확정(2026-08-05)** 예약 L671E2E0288 · 07:00부터 인수 가능. 사진·동영상으로 차체, 휠, 유리, 연료, 주행거리 기록. **프랑스 주행을 이 자리에서 신고한다 — 아래 참조** |
