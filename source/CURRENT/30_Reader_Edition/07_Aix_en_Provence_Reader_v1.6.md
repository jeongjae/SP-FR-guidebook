...
### 역사
로마 온천도시 Aquae Sextiae에서 시작해 프로방스 백작령의 수도, 근대 법률·행정·대학도시로 발전했다.

### 경제
관광과 문화 외에 대학·법률·행정·첨단산업이 결합된 생활도시다.

### 사회
Marseille보다 작고 부유하며, 학생·전문직·장기거주자가 만든 안정된 도심생활권이 강하다.

### 문화
시장·분수·사유지 저택과 Cézanne의 작업세계가 도시브랜드를 형성한다.

### 이번 여행에서의 의미
Aix는 명소를 많이 보는 곳이 아니라 시장과 미술, 개인시간을 반복하는 도시다.
...
| 항목 | 실행정보 |
|---|---|
| 방문 방법 | Rotonde에서 동쪽으로 도보. |
| 권장 관람법 | 분수 3곳과 남북 파사드의 차이를 보고 카페는 한 번만 이용한다. |
| 권장 체류 | 45–60분 |
| 요금·예약 | 무료. |
| 주의사항 | 시장·행사 시 혼잡. |
...
| 항목 | 실행정보 |
|---|---|
| 방문 방법 | 중심부에서 버스·택시 또는 오르막 도보. |
| 권장 관람법 | 진열물보다 창밖 빛, 정물 오브제, 작업동선을 본다. |
| 권장 체류 | 45–60분 |
| 요금·예약 | 시간지정 유료, 예약 권장. |
| 주의사항 | 15분 전 도착, 공간이 작음. |
...
| 항목 | 실행정보 |
|---|---|
| 방문 방법 | Aix에서 차량, 외곽주차+셔틀 우선. |
| 권장 관람법 | 항구 체류를 짧게 하고 보트 또는 해안지형에 시간을 배분한다. |
| 권장 체류 | 2–4시간 |
...
| 항목 | 실행정보 |
|---|---|
| 방문 방법 | Cassis 보트 또는 허용된 육상경로. |
| 권장 관람법 | 보트에서는 만의 형태와 절벽층을 보고, 긴 하이킹은 하지 않는다. |
| 권장 체류 | 60–120분 |
...
|---|---|
| 방문 방법 | Aix 체크아웃 후 차량. |
| 권장 관람법 | 성 외관·마을·스케치행사 중 2개만 선택. |
| 권장 체류 | 90–150분 |
| 요금·예약 | 마을 무료, 성·행사 유료 가능. |
| 주의사항 | 농가 체크인과 Coustellet 장보기 우선. |
