...
chapter: 10
version: "1.3"
status: "Reader Pass C 실행본 — 전환일·Annecy·Paris 이동 통제 강화"
...
- **9/21:** Avignon TGV 렌터카 반납은 열차보다 75–90분 앞서 완료한다. Lyon 도착이 45분 이상 늦으면 Bellecour 짧은 산책과 숙소식만 남긴다.
- **9/22:** Fourvière는 푸니쿨라로 올라가고 비에는 정원 하산을 취소한다. 저녁 전 1시간 휴식을 보호한다.
- **9/23:** Halles 점심 뒤 공원은 회복블록이다. 이동이 늦어지면 러닝과 수영부터 삭제한다.
- **9/24:** Annecy 열차장애·강풍 시 크루즈부터 삭제한다. 대규모 장애면 Lyon 생활일로 완전히 교체한다.
- **9/25:** 열차 90분 전 숙소 출발. 아침 시장보다 Paris 연결을 우선한다.
