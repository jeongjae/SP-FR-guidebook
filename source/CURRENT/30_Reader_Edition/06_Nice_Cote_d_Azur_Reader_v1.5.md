...
### {{VISUAL:VIS-MAP-013|type=map|status=linked|strategy=execution-map}} 니스와 코트다쥐르 전체 개요 지도
- 설명: Nice 숙소권, Nice-Ville역, Cannes, Monaco, 9/8 Nice 생활모듈, NCE Terminal 2, Saint-Paul-de-Vence, Grasse, Aix 이동축을 한 장에 정리한다.

### {{VISUAL:VIS-MAP-014|type=map|status=linked|strategy=execution-map}} 9/5 니스 도보 동선 지도
- 설명: 숙소권에서 Cours Saleya, Vieux Nice, Colline du Château, Promenade, Port까지 이어지는 도보 동선.

### {{VISUAL:VIS-MAP-015|type=map|status=linked|strategy=execution-map}} 9/6 Cannes 당일치기 동선 지도
- 설명: Nice-Ville, Cannes역, Marché Forville, Le Suquet, Vieux-Port, Croisette, 귀환 동선.

### {{VISUAL:VIS-MAP-016|type=map|status=linked|strategy=execution-map}} 9/7 Monaco 당일치기 동선 지도
- 설명: Monaco-Monte-Carlo역, Monaco-Ville, Palace Square, Cathedral, Port Hercule, Casino Square 선택동선.

### {{VISUAL:VIS-MAP-017|type=map|status=linked|strategy=execution-map}} 9/8 Nice 생활·회복 지도
- 설명: Marché de la Libération, Cimiez·Matisse 또는 Chagall, 숙소 휴식, Promenade 저녁산책을 연결한다.

### {{VISUAL:VIS-MAP-018|type=map|status=linked|strategy=execution-map}} 9/9 Nice→Saint-Paul-de-Vence→Grasse→Aix 이동 지도
...
### {{VISUAL:VIS-PHOTO-023|type=photo|status=travel-capture|strategy=direct-shot}} 꽃과 식품 노점이 이어진 Cours Saleya
...
### {{VISUAL:VIS-PHOTO-024|type=photo|status=pre-publication|strategy=licensed-or-direct}} Vieux Nice의 주황빛 건물과 좁은 골목
...
### {{VISUAL:VIS-PHOTO-025|type=photo|status=pre-publication|strategy=licensed-or-direct}} Castle Hill에서 내려다본 Baie des Anges
...
### {{VISUAL:VIS-PHOTO-026|type=photo|status=pre-publication|strategy=licensed-or-direct}} Croisette의 야자수와 호텔 파사드
...
### {{VISUAL:VIS-PHOTO-027|type=photo|status=pre-publication|strategy=licensed-or-direct}} Monaco-Ville 성벽과 바다 전망
...
### {{VISUAL:VIS-PHOTO-028|type=photo|status=pre-publication|strategy=licensed-or-direct}} Saint-Paul-de-Vence 성문과 석조 골목
...
### {{VISUAL:VIS-PHOTO-029|type=photo|status=pre-publication|strategy=licensed-or-direct}} 향수 체험 테이블 또는 향수 بوتीक 디스플레이
...
### {{VISUAL:VIS-PHOTO-030|type=photo|status=travel-capture|strategy=direct-shot}} petits farcis 또는 socca 한 접시
...
### {{VISUAL:VIS-PHOTO-031|type=photo|status=travel-capture|strategy=direct-shot}} Libération 시장의 생활형 장보기 풍경
