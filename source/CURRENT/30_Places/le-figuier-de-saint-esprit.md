---
slug: le-figuier-de-saint-esprit
name: "Le Figuier de Saint-Esprit"
local_name: "Restaurant Le Figuier de Saint-Esprit"
region: nice
kind: spot
grade: "필수"
priority: "MUST_SEE"
content_tier: "TIER_A"
selection_origin: "WISH"
meal_role: "PRIMARY"
food_kind: "RESTAURANT"
summary: "앙티브 옛 성벽 골목에 위치한 미쉐린 1스타 레스토랑. 셰프 크리스티앙 모리세의 섬세한 남프랑스 지중해 미식."
source: source/CURRENT/30_Places/le-figuier-de-saint-esprit.md
---
...
- **Best For**: 특별한 지중해 파인다이닝 런치, 앙티브 구시가지 미식 탐방
- **Best Context**: Day 09 (일요일) 앙티브 구시가지 및 프로방스 시장 산책 후 점심
- **Recommended Duration**: 90~105분

## 더 깊이

### 1. 셰프 크리스티앙 모리세와 무화과나무 중정
...
### 2. 시그니처 요리와 코스 구성
1. **Caneloni de calmar et palourdes à l’encre de seiche**: 오징어 먹물로 빚은 얇은 피에 조개와 오징어를 채우고 맑은 조개 쥐(jus)를 곁들인 전설적인 시그니처 전채.
2. **Selle d’agneau des Alpilles en croûte d’argile**: 발로리스 도자기 점토로 감싸 화덕에서 서서히 익혀 육즙을 완벽히 가둔 알피유 양등심 구이.
3. **런치 포뮬러**: 계절 식재료를 반영한 런치 코스(2코스 약 €55, 3코스 약 €61, 4코스 약 €75) 및 풀 테이스팅 메뉴(Menu du Figuier 약 €118).
...
| **공식 정보** | [공식 웹사이트](https://www.restaurant-lefiguierdesaintesprit.fr/) (verified_at: 2026-08-21) |
