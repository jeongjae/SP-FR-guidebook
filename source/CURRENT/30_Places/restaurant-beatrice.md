...
name: "Restaurant & Salon de Thé Béatrice"
local_name: "Restaurant et Salon de Thé Béatrice — Villa Ephrussi de Rothschild"
region: nice
kind: spot
grade: "필수"
priority: "MUST_SEE"
...
summary: "에프뤼시 드 로스차일드 저택 내부의 우아한 살롱과 지중해 전망 테라스에서 즐기는 로맨틱 런치."
source: source/CURRENT/30_Places/restaurant-beatrice.md
---
...
### 1. 베아트리스 드 로스차일드 남작부인의 살롱
로스차일드 가문의 상징적인 분홍빛 팔라초 1층에 자리하여, 18세기 프랑스 가구와 장식 예술품으로 둘러싸인 우아한 실내 분위기를 유지하고 있다.

### 2. 대표 메뉴와 지중해식 플레이트
1. **Salade Béatrice**: 훈제 연어, 감귤류, 아보카도, 니스 올리브를 곁들인 상큼한 시그니처 샐러드.
2. **Plat du Jour**: 제철 프로방스 채소 콩피와 바질 오일을 곁들인 대구(Cabillaud) 또는 도미 구이.
3. **Salon de Thé & Pâtisserie**: 트로페시엔 타르트(Tarte Tropézienne), 라즈베리 타르트, 마리아주 프레르 티 셀렉션.
...
| **좌표** | 43.6865, 7.3323 |
| **운영 시간** | 점심 서비스 12:00–15:00 · 살롱 드 테(티/디저트) 15:00–17:30 |
