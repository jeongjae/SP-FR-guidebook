...
Phase 8은 **Known-Facts Lock**까지 완료했으나, 실제 예약 잠금은 외부 입력이 없어 차단되어 있다.  
현재 문서와 Tracker에 존재하지 않는 예약번호·숙소주소·편명·열차번호·결제금액을 임의 생성하지 않았다.
...
1. 국제선·Girona→Nice 항공 또는 철도 상세
2. 두 렌터카 예약서
3. Avignon→Lyon, Lyon→Paris 열차표
4. 8개 숙소의 확정명·주소·예약번호·금액·취소기한
5. 핵심 입장권·공연·축구 예약정보
6. 여행자보험·통신
