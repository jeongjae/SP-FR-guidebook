...
| F033 | Paris | Musée de l’Orangerie | 휴관·예약 | CORRECTED | **화요일 휴관.** 9/29(화)는 Orsay 일정으로 유지하고 Orangerie는 9/30(수) 10:00–11:30에 90분 집중 관람한다. 9/30 10:00 시간지정 입장은 예약 확정이며 수련과 Walter-Guillaume 주요작을 우선한다. | [공식](https://www.musee-orangerie.fr/en/visit-orangerie) | 예약 완료 · 티켓 오프라인 저장 |
