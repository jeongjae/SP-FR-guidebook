...
chapter: 07
version: "1.2"
status: "상용 가이드북형 장소·식당 보강본 — 숙소·세잔 명소·보트·교통 실시간 예약 전 최종 확인 필요"
...
- **목표 총액:** €650~900 / 2인 4박. 주차·취소조건이 우수하면 €1,000까지 비교
- 포함해서 비교: 객실료, VAT, 관광세, 주차 4박, 필수 청소비, 취소가능요금 차액
- 아파트호텔은 조식 불포함으로 비교한다.
- 중심 공영주차를 별도로 사용하면 Rotonde 기준 24시간 상한이 €25이므로 4박에도 상당한 추가비용이 생길 수 있다.
...
- 주의: 프런트 운영시간이 호텔보다 제한될 수 있으므로 9/9 늦은 도착과 일요일 체크아웃 방식 확인
...
- 숙소에 주차한 뒤 **9/10·9/12**는 차를 움직이지 않는다. 9/11 Cassis에는 차량을 사용한다.
...
| 행사·전시 | 기간 | 일정 반영 | 판단 |
|---|---|---|---|
| Paul McCartney, Photographer 1963–64: Eyes of the Storm | 2026-07-04~2027-01-03 | **9/10 Musée Granet** | **우선 추천** |
...
### 지도 브리프 Aix 생활권·Cassis 기본일·Marseille 대체일 지도
- 설명: 숙소권, Richelme 시장, Cézanne 장소, L50 버스축, Cassis 주차·항구를 표시한다.

### 사진 브리프 Cours Mirabeau의 플라타너스와 분수
- 설명: 관광대로이면서 현지인의 이동·카페·시장축인 엑상의 대표 생활풍경.

### 사진 브리프 Cassis 항구와 Calanques 석회암 절벽
...
- 숙소 실제 후보 순위와 계획예산
- **9/11** 보트 코스를 3 또는 5 Calanques 중 최종 선택
