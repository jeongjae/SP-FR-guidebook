# EX-15 — Departure User Action List
## Final Operational Action Items, Channels & Execution Deadlines

---

## 1. ACTION-A — Before Departure Mandatory (출발 전 필수 실행: T-7 ~ D-Day)

| Priority | Deadline | Target Day / Date | Entity / Venue | Location | Official Booking Channel | Action Required | Current Status |
|---|---|---|---|---|---|---|---|
| **ACTION-A1** | **T-1 (8.28 12:45)** | Day 01 (8.29) | **OZ511 항공편** | 인천 ➔ 바르셀로나 | [flyasiana.com](https://flyasiana.com) | 온라인 모바일 체크인 및 사전 좌석 확정 | `READY (T-1 오픈)` |
| **ACTION-A2** | **T-7 (8.22)** | Day 03 (8.31) | **Bar Cañete** | Barcelona 고딕 | [barcanete.com](https://barcanete.com) | 13:30 카운터 2인석 예약 최종 확인 | `ACTION_READY` |
...
## 2. ACTION-B — Before Relevant Travel Day (현지 여행 중 실행)
...
| **ACTION-B8** | **T-14 (9.17)** | Day 34 (10.01) | **Le Grand Pan** | Paris 15구 | [legrandpan.fr](https://legrandpan.fr) | 20:00 15구 숯불 티본 스테이크 예약 | `SCHEDULED` |
| **ACTION-B9** | **T-14 (9.24)** | Day 41 (10.08) | **Le Grand Pan** | Paris 15구 | [legrandpan.fr](https://legrandpan.fr) | 20:00 파리 15박 고별 만찬 예약 | `SCHEDULED` |

---

## 3. ACTION-C — Optional / Walk-In Confirmation (현장 판단 및 워크인)

| Priority | Deadline | Target Day / Date | Entity / Venue | Location | Operational Guideline | Current Status |
|---|---|---|---|---|---|---|
| **ACTION-C1** | 당일 (8.30) | Day 02 | **La Paradeta Sagrada Família** | Barcelona | 12:45 이전 조기 줄서기 (무예약 해산물 마켓) | `WALK_IN` |
| **ACTION-C2** | 당일 (9.27) | Day 30 | **Bouillon Chartier Montparnasse** | Paris | 18:30 이전 조기 입장 (무예약 클래식 부용) | `WALK_IN` |
| **ACTION-C3** | T-3 (9.23) | Day 29+ | **Marché Convention** | Paris 15구 | 화/목/일 07:00~14:30 개장 확인 후 장보기 | `WALK_IN` |
