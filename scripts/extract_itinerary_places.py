...
PLACES = {
    ...
    "petit-palais": p("Petit Palais", "프티 팔레", "museum", "paris", "major"),
    "chez-savy": p("Chez Savy", "셰 사비", "restaurant", "paris", "supporting"),
    "palais-de-tokyo": p("Palais de Tokyo", "팔레 드 도쿄", "museum", "paris", "major"),
    "palais-garnier": p("Palais Garnier", "오페라 가르니에", "attraction", "paris", "major"),
    ...
    "musee-rodin": p("Musée Rodin", "로댕 미술관", "museum", "paris", "major"),
    "hotel-des-invalides": p("Hôtel des Invalides", "앵발리드", "historic-site", "paris", "supporting"),
...
DAY_REFS = {
    ...
    30: [("petit-palais", "confirmed"), ("jardin-des-tuileries", "confirmed"), ("palais-royal", "confirmed"), ("palais-garnier", "confirmed")],
    31: [("musee-du-louvre", "confirmed"), ("palais-royal", "optional")],
    32: [("versailles", "confirmed"), ("versailles-gardens", "confirmed"), ("trianon", "optional"), ("paris-15e", "reference")],
    33: [("musee-de-l-orangerie", "confirmed"), ("chez-savy", "confirmed"), ("grand-palais", "confirmed"), ("palais-de-tokyo", "confirmed"), ("paris-15e", "reference")],
    34: [("musee-d-orsay", "confirmed"), ("musee-rodin", "confirmed"), ("hotel-des-invalides", "optional"), ("paris-15e", "reference")],
