...
ICONS = {
 "today":   '<circle cx="12" cy="12" r="8.2"/><circle cx="12" cy="12" r="3.2" fill="#000" stroke="none"/>',
 ...
 "region":  '<circle cx="12" cy="12" r="8.4"/><path d="M12 6.6 14.1 12 12 17.4 9.9 12Z" fill="#000" stroke="none"/>',
 ...
 "gauge":   '<path d="M4 16.5a8.6 8.6 0 1 1 16 0"/><path d="M12 16.5 16 10"/><circle cx="12" cy="16.5" r="1.4" fill="#000" stroke="none"/>',
 ...
 "train":   '<rect x="5.4" y="3.6" width="13.2" height="13.4" rx="3"/><path d="M5.4 10.6h13.2"/><path d="M8.6 21l1.8-4M15.4 21l-1.8-4"/><circle cx="9" cy="13.8" r="1"  fill="#000" stroke="none"/><circle cx="15" cy="13.8" r="1" fill="#000" stroke="none"/>',
 ...
 "alert":   '<path d="M12 3.6 21.6 19.8a1 1 0 0 1-.9 1.4H3.3a1 1 0 0 1-.9-1.4Z"/><path d="M12 9.6v5"/><circle cx="12" cy="17.6" r="1.1" fill="#000" stroke="none"/>',
 ...
 "car":     '<rect x="3.2" y="10.2" width="17.6" height="6.4" rx="2"/><path d="M5.8 10.2 7.3 6.4a1.9 1.9 0 0 1 1.8-1.2h5.8a1.9 1.9 0 0 1 1.8 1.2l1.5 3.8"/><path d="M5.4 16.6v2.2M18.6 16.6v2.2"/><circle cx="7.4" cy="13.4" r="1" fill="#000" stroke="none"/><circle cx="16.6" cy="13.4" r="1" fill="#000" stroke="none"/>',
 ...
 "sound":   '<polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5" fill="#000"/><path d="M15.5 8.5a5 5 0 0 1 0 7"/><path d="M19 5a9.5 9.5 0 0 1 0 14"/>',
...
# 아니라 모양에 실려 있어야 한다. 채운 도형은 fill=#000 로 마스크에 싣는다.
GRADE_ICONS = {
 "essential":   '<path d="M12 2.6 21.4 12 12 21.4 2.6 12Z" fill="#000" stroke="none"/>',
 "priority":    '<circle cx="12" cy="12" r="7.6" fill="#000" stroke="none"/>',
