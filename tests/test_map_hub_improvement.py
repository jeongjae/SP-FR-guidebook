...
class MapHubImprovementTests(unittest.TestCase):
    ...
    def test_route_urls_are_directions_with_valid_modes(self):
        ...
        self.assertEqual(len(routes), 132, "Paris Day 33 공개 동선 분리 후 총 132개 경로")
    ...
    def test_map_index_region_groups_and_date_formatting(self):
        ...
        self.assertEqual(total_pins, 184, "Paris 공개 동선 분리 후 총 핀 수는 184")
        ...
        self.assertEqual(len(matches), 184, "184개 항목 모두 날짜 메타가 존재해야 함")
