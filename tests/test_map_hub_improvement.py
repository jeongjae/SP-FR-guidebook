...
class MapHubImprovementTests(unittest.TestCase):
    ...
    def test_route_urls_are_directions_with_valid_modes(self):
        ...
        self.assertEqual(len(routes), 113, "Batch 09 Day 36–39 실행 목적지 포함 총 113개 경로 항목이 정의되어야 함")
    ...
    def test_map_index_region_groups_and_date_formatting(self):
        ...
        self.assertEqual(total_pins, 176, "Batch 07 Paris 장소 좌표 반영 핀 포함 총 핀 수는 176이어야 함")
        ...
        self.assertEqual(len(matches), 176, "176개 항목 모두 날짜 메타가 존재해야 함")
