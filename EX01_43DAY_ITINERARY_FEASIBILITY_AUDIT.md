...
1. **Day 4 (9/1 화) Barcelona → Sitges → Bàscara (Grade C)**:
   - *동선*: 바르셀로나 숙소 체크아웃(08:00) ➔ 산츠역 렌터카 인수(09:00, 확정 L671E2E0288) ➔ 시체스 이동(45분) ➔ Cau Ferrat / Maricel 관람 ➔ La Zorra 점심 ➔ 바스카라 숙소 이동(175km, 1시간 45분) ➔ 체크인.
...
3. **Day 12 (9/9 수) Nice → Saint-Paul-de-Vence → Grasse → Aix-en-Provence (Grade C)**:
   - *동선*: 니스 체크아웃(08:45) ➔ 니스역 렌터카 인수(09:00, 확정 L672E080313) ➔ 생폴드방스(45분) ➔ 그라스(40분, 점심) ➔ 엑상프로방스 이동(155km 고속도로, 1시간 45분) ➔ 체크인.
...
6. **Day 23 (9/20 일) Avignon → Lyon (Grade C)**:
   - *동선*: 주유 ➔ 아비뇽 TGV역 렌터카 반납(09:00) ➔ TGV 12176 탑승(10:22 -> 11:28, 1등석 확정 4YMAGT) ➔ 리옹 라그랑주 뤼미에르 체크인(15:00) ➔ 벨쿠르/셀레스탱 산책.
...
7. **Day 27 (9/24 목) Lyon → Paris (Grade B)**:
   - *동선*: 리옹 체크아웃(11:00) ➔ TGV 6618 탑승(13:04 -> 15:00, 확정 X6CVW5) ➔ 파리 리옹역 택시 이동 ➔ 15구 숙소 체크인(15박 장기 체류 정착) ➔ 생활 장보기 및 세탁.
